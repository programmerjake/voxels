...
public final class PlayerList {
	...
	private static class Node {
		...
		public Node(String new_name, Player new_p, String new_password,
	...
	private Node insertPlayer(Player p, Socket connection, String name,
			String password) {
	...
	public void draw() {
		if (this.head == null) {
			...
			Text.draw(Matrix.setToTranslate(draw_t1, -textwidth / 2,
					-textheight / 2, -20), RGB(255, 0, 0), errormsg);
		} else {
			this.head.p.drawAll();
		}
	}
	 ...
	 * @return <code>rs</code>
	 */
	public RenderingStream drawPlayers(RenderingStream rs, Matrix worldToCamera) {
	 ...
	 */
	public Player.MouseMoveKind handleMouseMove(float mouseX, float mouseY,
